...
async def main():
    ...
    if user_question:
        ...
        # 7. Otherwise prin the info that `No users found matching`
        else:
            print(f"No users found matching '{user_question}'")
            print("\nTry refining your search or using different keywords.")

        # 8. In the end print info about usage, you will be impressed of how many tokens you have used. (imagine if we have 10k or 100k users 😅)
